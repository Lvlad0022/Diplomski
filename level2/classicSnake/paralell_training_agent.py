...
import torch
import numpy as np
from q_logic.q_logic_parallel import Agent_inference
...
class snakeAgent_inference(Agent_inference):
    def __init__(self, train = True,n_step_remember=1,  gamma=0.93, model = None, noisy_net = False, attention = False, on_gpu = True
                  ):
